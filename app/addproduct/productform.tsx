  ...
  return (
    <div className='px-5 max-w-[1280px] mx-auto mb-10'>
      ...
      <h1 className='text-3xl font-semibold py-6'>
        Add your product n SEINE
      </h1>
      <div className='text-black mt-4'>
        <div className='grid md:grid-cols-2 grid-cols-1 gap-5'>
          <div>
            <label htmlFor="title" className='font-medium'>Title</label>
            <input type="text" className='w-full h-[50px] border-[1px] rounded-lg focus:border-pink-500 px-3 focus:border-2 outline-none'
            name='title'
          ...
          <label htmlFor='inventory' className='font-medium'>
            ...
            <input type="number" className='w-full h-[50px] border-[1px] rounded-lg focus:border-pink-500 px-3 focus:border-2 outline-none'
            name='inventory'
