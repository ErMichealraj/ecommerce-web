        ...
        return(
          <ul className='py-5 px-1 text-neutral-600'>
            <li className='hover:bg-gray-100 hover:text-neutral-900 px-5 py-2 cursor-pointer'>
              ...
              <li onClick={() => signOut()} className='whitespace-nowrap hover:text-red-600 px-5 py-2 cursor-pointer'>
                SignOut
            </li>
        ...
        <div className='flex items-center md:space-x-10 lg:space-x-20'>
          ...
          <nav className='max-md:hidden'>
            <ul className='flex items-center lg:space-x-10 space-x-7 opacity-70 text-[15px]'>
              <li><a href='/' className='py-3 inline-block w-fu'>Shop</a></li>
              <li><a href='filters' className='py-3 inline-block w-fu'>Filters</a></li>
              <li><a href='myProducts' className='py-3 inline-block w-fu'>My Products</a></li>
            </ul>
          </nav>
        </div>
